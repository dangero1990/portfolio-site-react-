  ...
  return (
    <section className='nes-container with-title is-dark is-rounded'>
      ...
      <div className='card-grid'>
        ...
        <Card img={adviceGenerator} header='advice generator' description='a web app for generatoring random life advice' link='https://precious-treacle-42b54b.netlify.app/' />
      </div>
